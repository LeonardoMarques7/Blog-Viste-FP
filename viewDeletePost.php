    ...
    <div class="container">
        <main id="posts-container">
            ...
            <form name="produto" action="deletePost.php" class="form border rounded shadow-lg" method="post" enctype="multipart/form-data"><br><br>
                <h1 style="color: #39f;">Deletando Post</h1><br>
                <div class="col form-control">
                    <img src="<?php echo "posts/$foto" ?>" style="max-width: 100%; margin: 0 auto;" readonly>
                </div><br>
                ...
                <div class="col text-start">
                    <b>Assunto Completo Post:</b><br><textarea class="form-control border-primary" name="assunto" id="assunto" placeholder="Sem dados!" title="Não é possível Alterar no DELETE" readonly><?php echo $dados['assuntoCompleto']?></textarea>
                </div><br>
                <div class="col text-start">
                ...
                <div class="col text-start">
                    <b>Data de Cadastra:</b><br><input class="form-control text-center border-primary" name="datePost" id="datePost" type="datetime-local"  placeholder="Sem dados!" title="Não é possível Alterar no DELETE" value="<?php echo $dados['datePost'];?>" readonly></input>
                </div><br>
                <div class="d-grid col-md-9">
                    <input type='hidden' name='codigo' value="<?php echo $dados['codigo']; ?>">
                    <button class="btn btn-primary" type="submit" title="Enviar" style="color: 444;">Excluir</button>
                    <a href="dashbord.php"><button class="btn btn-outline-danger" type="button" title="Enviar" style="color: 444;">Cancelar</button></a>
                </div>
                <br><br>
            </form>
        </main>
