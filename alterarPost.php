        ...
        <main id="posts-container">
            <?php
                ...
                if (!empty($foto)) {
                    ...
                    $sqlupdate = "UPDATE post SET foto='$foto', titulo='$titulo', assuntoIntro='$assuntoIntro', assuntoCompleto='$assuntoCompleto', autor='$autor', datePost='$datePost' WHERE codigo='$codigo'";
                } else {
                    // Se nenhum novo arquivo foi enviado, manter o valor atual do campo "imagem"
                    $sqlupdate = "UPDATE post SET titulo='$titulo', assuntoIntro='$assuntoIntro', assuntoCompleto='$assuntoCompleto', autor='$autor', datePost='$datePost' WHERE codigo='$codigo'";
                }
