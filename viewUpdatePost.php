    ...
    <div class="container">
        <main id="posts-container">
            ...
            <form name="produto"  style="padding: 50px; padding-top: 0px;" action="alterarPost.php" class="form border rounded shadow-lg" method="post" enctype="multipart/form-data"><br><br>
                <h1 style="color: #39f;">Editando Post</h1><br>
                <div class="col form-control">
                    <img src="<?php echo "posts/$foto" ?>" style="max-width: 100%; margin: 0 auto;" >
                </div><br>
                ...
                <div class="col text-start">
                    <b>Assuno do Introdutório:</b><br><textarea name="assuntoIntro" id="assunto" class="form-control" value='<?php echo $dados['assuntoIntro'];?>'><?php echo $dados['assuntoIntro'];?></textarea><br>
                    <button class="btn-small-textarea" type="button" onclick="adicionarAtalho('<strong></strong>')"><i class="fa-solid fa-bold"></i></button>
                    <button class="btn-small-textarea" type="button" onclick="adicionarAtalho('<em></em>')"><i class="fa-solid fa-italic"></i></button>
                    <button class="btn-small-textarea" type="button" onclick="adicionarAtalho('<a href=&quot;URL&quot;>TITULO-LINK</a>')"><i class="fa-solid fa-link"></i></button>
                    <script>
                ...
                <div class="col text-start">
                    ...
                    <button class="btn-small-textarea" type="button" onclick="adicionarAtalho2('<strong></strong>')"><i class="fa-solid fa-bold"></i></button>
                    <button class="btn-small-textarea" type="button" onclick="adicionarAtalho2('<em></em>')"><i class="fa-solid fa-italic"></i></button>
                    <button class="btn-small-textarea" type="button" onclick="adicionarAtalho2('<a href=&quot;URL&quot;>TITULO-LINK</a>')"><i class="fa-solid fa-link"></i></button>
                    <script>
                ...
                <div class="col text-start">
                    <b>Data de Cadastra:</b><br><input class="form-control text-center border-primary" name="datePost" id="datePost" type="datetime-local" required title="Digite data do Post" value="<?php echo $dados['datePost'];?>"></input>
                </div><br>
                <div class="d-grid col-md-9">
                    ...
                    <a href="dashbord.php"><button class="btn btn-voltar" type="button" title="Voltar"> Voltar</button></a>
                </div>
                <br><br>
            </form>
        </main>
